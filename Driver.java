...
public class Driver {
	...
	public static void main(String[] args) {
        ...
        generateWithParameters(3, 1000, 2.0,1,1, "File"+fileNo+".txt");
        ...
        generateWithParameters(5, 1000, 2.0,1,1, "File"+fileNo+".txt");
		generateWithParameters(10, 1000, 0.5,1,1, "File"+fileNo+".txt");
		generateWithParameters(10, 1000, 1,1,1, "File"+fileNo+".txt");
		generateWithParameters(10, 1000, 1.5,1,1, "File"+fileNo+".txt");
        generateWithParameters(10, 1000, 2.0,1,1, "File"+fileNo+".txt");
		// Experiment 2
		generateWithParameters(5, 1000, 3,1,1, "File"+fileNo+".txt");
		generateWithParameters(5, 1000, 3,2,2, "File"+fileNo+".txt");
		generateWithParameters(5, 1000, 3,3,3, "File"+fileNo+".txt");
		// Experiment 3
		generateWithParameters(5, 1000, 1.25,0.75,2, "File"+fileNo+".txt");
		// Experiment 4
		generateWithParameters(5, 100, 1.25,0.75,0.75, "File"+fileNo+".txt");
		generateWithParameters(5, 1000, 1.25,0.75,0.75, "File"+fileNo+".txt");
